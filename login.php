...
include 'facebook-login.php'; // $loginUrl sẽ được tạo ở đây
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        /* Style cho nút Google nếu chưa có trong file CSS */
        .btn-google {
                            ...
                            <div class="auth__form">
                                <div class="auth__form-container">
                                    ...
                                    <div style="margin-top: 10px; text-align: center;">
                                        <a href="google-login.php" class="btn-google">Đăng nhập bằng Google</a>
                                    </div>

                                    <!-- ✅ Nút đăng nhập bằng Facebook -->
                                    <div style="margin-top: 10px; text-align: center;">
                                        <a href="<?= htmlspecialchars($loginUrl) ?>" class="btn-facebook">Đăng nhập bằng Facebook</a>
                                    </div>
