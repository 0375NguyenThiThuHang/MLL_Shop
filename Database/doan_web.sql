...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 24, 2025 lúc 09:25 AM
...
(5, 'My hang', 'thuhang@gmail.com', 'hang122', '2180600375', '12');
...
INSERT INTO `tbl_user` (`userId`, `name`, `username`, `userPassword`, `email`, `gioiTinh`, `sdt`, `ngaySinh`, `diaChi`, `cauHoiBM`) VALUES
...
ALTER TABLE `tbl_order`
  ...
  ADD CONSTRAINT `tbl_order_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `tbl_user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;
