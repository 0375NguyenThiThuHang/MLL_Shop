...
class user
{
    ...
    public function insert_user($data)
    {
        ...
        if (
            ...
            if ($password != $relyPassword) {
                ...
                $check_username = "SELECT * FROM tbl_user WHERE username='$username' AND email='$email'  LIMIT 1";
                ...
                if ($result_check) {
                    ...
                    if ($result_mail) {
                        ...
                        $query = "INSERT INTO tbl_user(name,username,userPassword,email,gioiTinh,sdt,ngaySinh,diaChi,cauHoiBM) VALUES('$name','$username','$password'
    ...
    public function login_user($data)
    {
        ...
        if ($username == "" ||  $password == "") {
            ...
            $check_username = "SELECT * FROM tbl_user WHERE username='$username' AND userPassword='$password'";
    ...
    public function showKHAdmin()
    {
        ...
        FROM tbl_user AS us INNER JOIN tbl_order AS od ON us.userId =od.userId
        GROUP BY  od.userId
        ORDER BY od.userId";
        $result = $this->db->select($query);
        return $result;
    ...
    public function showCauHoiBiMat($username, $cauHoiBiMat)
    {
        ...
        if ($cauHoiBiMat == "" || $username == "") {
            ...
            $update_user = "SELECT * FROM tbl_user WHERE username='$username' AND cauHoiBM='$cauHoiBiMat'";
    ...
    public function updatePass($data)
    {
        ...
        if ($password == "" ||  $relyPassword == "") {
            ...
            if ($password != $relyPassword) {
                ...
                $update_user = "UPDATE tbl_user SET userPassword='$password'";
    ...
    public function update_user($user_Id, $data)
    {
        ...
        if ($name == "" ||  $email == "" ||  $phone == "" ||  $sex == "" ||  $date == "" ||  $address == "") {
            ...
            $update_user = "UPDATE tbl_user SET name='$name', email='$email', sdt='$phone', gioiTinh='$sex', ngaySinh='$date', diaChi='$address' WHERE userId='$user_Id'";
            $result_check = $this->db->update($update_user);
            if ($result_check) {
                $alert = "<span class='success'> Update Successfully </span>";
                return $alert;
    ...
    public function doimatkhau($taikhoan, $matkhaucu)
    {
        ...
        $sql = "SELECT * FROM tbl_user WHERE username= '$taikhoan' AND userPassword = '$matkhaucu'";
        $result = $this->db->select($sql);
        return $result;
    }
    //update mat khau
    public function updatedoimatkhau($matkhaumoi)
    {
        ...
        $sql_update = $this->db->update("UPDATE tbl_user SET userPassword= '$matkhaumoi' ");
